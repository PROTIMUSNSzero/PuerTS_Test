            ...
            try
            {
        ...
        
                {
                    ...
                    
                    {
                        ...
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<UnityEngine.Events.UnityAction<UnityEngine.SpriteRenderer>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); UnityEngine.Events.UnityAction<UnityEngine.SpriteRenderer> arg0 = (UnityEngine.Events.UnityAction<UnityEngine.SpriteRenderer>)argobj0;
    ...
    // ==================== properties start ====================
        ...
        private static void S_drawMode(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                UnityEngine.SpriteDrawMode arg0 = (UnityEngine.SpriteDrawMode)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value0, false);
                obj.drawMode = arg0;
        ...
        private static void S_tileMode(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                UnityEngine.SpriteTileMode arg0 = (UnityEngine.SpriteTileMode)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value0, false);
                obj.tileMode = arg0;
        ...
        private static void S_maskInteraction(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                UnityEngine.SpriteMaskInteraction arg0 = (UnityEngine.SpriteMaskInteraction)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value0, false);
        ...
        private static void S_spriteSortPoint(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                UnityEngine.SpriteSortPoint arg0 = (UnityEngine.SpriteSortPoint)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value0, false);
